...
argument-hint: "[stack or reviewer hints]"
---
...
- `${CLAUDE_PLUGIN_ROOT}/skills/review-orchestration/references/review-schema.md` — the format you must produce
- `${CLAUDE_PLUGIN_ROOT}/skills/review-orchestration/references/templates/` — starter reviewer sections per domain
...
Map findings to domain templates from `${CLAUDE_PLUGIN_ROOT}/skills/review-orchestration/references/templates/` (backend, frontend, devops,
...
- Whether to enable the **decision ledger** (`decisions: .reviewers/decisions/` — see
  `${CLAUDE_PLUGIN_ROOT}/skills/review-orchestration/references/decision-ledger.md`): a committed record of settled review decisions that
...
- Mention (don't push) the **baseline** (`${CLAUDE_PLUGIN_ROOT}/skills/review-orchestration/references/baseline.md`): for parking specific
