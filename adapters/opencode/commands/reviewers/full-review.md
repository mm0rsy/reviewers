...
`.opencode/skills/review-orchestration/references/decision-ledger.md`. When a prior iteration exists (synthesis.md Step 0),
...
draft a complete ledger entry per `.opencode/skills/review-orchestration/references/decision-ledger.md` (Decision, Rationale with
