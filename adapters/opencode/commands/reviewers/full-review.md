...
If a `decisions:` ledger is configured, read `.opencode/skills/review-orchestration/references/decision-ledger.md` and parse the
...
`.opencode/skills/review-orchestration/references/decision-ledger.md`.
