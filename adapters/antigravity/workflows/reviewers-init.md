...
- `.agents/skills/review-orchestration/references/review-schema.md` — the format you must produce
- `.agents/skills/review-orchestration/references/templates/` — starter reviewer sections per domain

Arguments given by the user: `the text the user typed after the workflow name` (treat as hints about the stack or desired reviewers).
...
Map findings to domain templates from `.agents/skills/review-orchestration/references/templates/` (backend, frontend, devops,
...
- Mention (don't push) the **baseline** (`.agents/skills/review-orchestration/references/baseline.md`): for parking specific
