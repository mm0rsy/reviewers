...
`{{REF_DIR}}/decision-ledger.md`. When a prior iteration exists (synthesis.md Step 0),
...
draft a complete ledger entry per `{{REF_DIR}}/decision-ledger.md` (Decision, Rationale with
